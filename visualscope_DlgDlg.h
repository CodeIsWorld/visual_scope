...
#define max_point_num 1000000//最大点数
...
// Implementation
	public:
		...
		CRect tRect1,tRect_disp_channel;//矩形画图背景
		CFont m_font,n_font,x_font;//创建字体
		float scoll_position,max_scoll_position;//滚动条位置
		SCROLLINFO xSi;//滚动条结构体
		int point_num,point_num_temp,bad_num,point_num_old,num_to_change;
		...
		int mouse_move_x,mouse_move_x_old;
